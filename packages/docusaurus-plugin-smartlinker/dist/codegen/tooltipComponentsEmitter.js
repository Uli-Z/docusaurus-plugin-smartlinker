 ...
 */
export function emitTooltipComponentsModule(components) {
    ...
    for (const [idx, [alias, spec]] of entries.entries()) {
        ...
        if (spec.exportName) {
            imports.push(`import { ${spec.exportName} as ${localName} } from '${spec.importPath}';`);
        }
        else {
...
//# sourceMappingURL=tooltipComponentsEmitter.js.map