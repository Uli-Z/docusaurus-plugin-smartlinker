...
export default function SmartLink({ to, children, tipKey, icon, match }) {
    ...
    const textNode = (_jsx("a", { href: to, className: "lm-smartlink__anchor", "data-tipkey": tipKey ?? undefined, onClick: onAnchorClick, children: _jsx("span", { className: "lm-smartlink__text", children: children }) }));
    ...
    const iconLabel = !isHoverCapable
        ? baseLabel
            ...
            : 'Open tooltip'
        : undefined;
    const iconNode = icon ? (_jsx("a", { href: to, className: "lm-smartlink__iconlink", onClick: (e) => {
